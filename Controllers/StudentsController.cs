...
namespace ApiStudent.Controllers
{
    ...
    public class StudentsController : ControllerBase
    {
        ...
        // GET: api/Students
        [HttpGet]
        public async Task<ActionResult<IEnumerable<Student>>> GetStudnets()
        {
            return await _context.Studnets.ToListAsync();
        }
        ...
        {
            var student = await _context.Studnets.FindAsync(id);
        ...
        public async Task<IActionResult> DeleteStudent(int id)
        {
            ...
            _context.Studnets.Remove(student);
            await _context.SaveChangesAsync();
